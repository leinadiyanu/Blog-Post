...
export const register = async (req, res, next) => {
  ...
  if (error) {
    ...
    const role = (email === "iyanuoluwaakande33@gmail.com" || email === "danielakande33@gmail.com")  ? "admin"  : "user";

    const user = await User.create({ name: {firstName, surname}, email, password: hashedPassword, role });
